                        ...
                        <tbody>
                            @foreach ($Category as $kategoriler)
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge" style="background-color:{{ $kategoriler->category_color }};">
                                    ...
                                    <td>
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" id="flexSwitchCheckChecked"
                                                role="switch" @if (!$kategoriler->category_status == '0') checked @endif />
                                        </div>
                                    </td>
                                    <td>
    ...
    {{-- <script>
        function GetImages(GetImage){
            if((GetImage == null) && (GetImage == "")){
                $("#get_images").text("Resim Bulunamadı ! ");
            }
            else{
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response != null) {
                            ...
                            if (response[0].category_description != null) {
